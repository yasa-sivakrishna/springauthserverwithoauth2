package com.sky.springauthserver.configuration;
...
public class SecurityConfig {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient clientCredClient = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("skyorgapi")
                .clientSecret("{noop}VxubPgAXyyTq9lGjj3qGvWPsHtE4SqTq")
        ...
        RegisteredClient introspectClient = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("skyorgintrospect")
                .clientSecret("{noop}c96BK9Bg2REeydBbvUoUeICbD2bvJzXGj")
                .clientAuthenticationMethod(ClientAuthenticationMethod.CLIENT_SECRET_BASIC)
                .authorizationGrantType(AuthorizationGrantType.CLIENT_CREDENTIALS)
        ...
        RegisteredClient authCodeClient = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("skyorgclient")
                .clientSecret("{noop}Qw3rTy6UjMnB9zXcRTY2pL0sKjHn5TxQqUY")
